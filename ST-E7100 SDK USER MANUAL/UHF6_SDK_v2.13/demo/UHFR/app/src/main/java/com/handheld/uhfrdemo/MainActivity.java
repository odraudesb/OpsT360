...
public class MainActivity extends FragmentActivity implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * To resolve the problem of every time you click the desktop icon, the MainActivity page will be launched
     */
    ...
    protected void onStart() {
        ...
        if(mUhfrManager!=null){
            ...
            if(err== Reader.READER_ERR.MT_OK_ERR){
                ...
                Toast.makeText(getApplicationContext(),"FreRegion:"+Reader.Region_Conf.valueOf(mUhfrManager.getRegion().value())+
