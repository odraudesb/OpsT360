...
namespace BRBKWebApiData
{
    public class itemsDA : Base
    {
        ...
        public static List<items> listadoItems(out string OnError)
        {
            OnInit("N4Middleware");
            parametros.Clear();
            return sql_puntero.ExecuteSelectControl<items>(nueva_conexion, 4000, "[brbk].consultarItems", parametros, out OnError);
        }
