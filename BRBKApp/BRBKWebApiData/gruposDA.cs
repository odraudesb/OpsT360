...
namespace BRBKWebApiData
{
    public class gruposDA : Base
    {
        ...
        public static grupos GetGrupos(int _id)
        {
            OnInit("N4Middleware");
            parametros.Clear();
            parametros.Add("i_id", _id);
            return sql_puntero.ExecuteSelectOnly<grupos>(nueva_conexion, 4000, "[brbk].consultarGrupos", parametros);
        }
        ...
        public static DataView consultaGrupos()
        {
            ...
            using (var c = cn)
            {
                ...
                coman.CommandText = "[brbk].consultarGrupos";
                try
                {
                    c.Open();
