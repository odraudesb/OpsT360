...
{
    public class FclSealYardValidationViewModel : BaseViewModel
    {
        ...
        public FclSealYardValidationViewModel()
        {
            Title = "Seal Yard Validation";
                ...
                if (DeACuerdo)
                {
                    ...
                    if (flags == false)
                    {
                        ...
                        if (current == NetworkAccess.Internet)
                        {
                            ...
                            ValidaSealPatio objSeal = new ValidaSealPatio();
                            ...
                            ApiModels.AppModels.Base msg = await datos.SetSealValidationYard(objSeal, ArrayFoto, ArrayFoto1, ArrayFoto2, ArrayFoto3).ConfigureAwait(true);
