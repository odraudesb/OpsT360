...
{
    public class CediNovedadDetalleTarjaViewModel : BaseViewModel
    {
        ...
        public CediNovedadDetalleTarjaViewModel(Models.AppModelNovedadDetalleTarja detalle)
        {
        ...
        private async void OnSaveClicked()
        {
            ...
            try
            {
                ...
                var response = await ServiceCedi.RegistrarCediNovedadDetalleTarja(request);
