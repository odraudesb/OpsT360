...
{
    public class CediTarjaCrearViewModel : BaseViewModel
    {
        ...
        public CediOrdenTrabajo CurrentEntry { get; set; }
        public CediTarjaCrearViewModel(CediOrdenTrabajo ordenTrabajo)
        {
            Title = "Creando Tarja";
        ...
        private async void OnCrearClicked()
        {
            ...
            if (answer)
            {
                ...
                await Shell.Current.GoToAsync("////CediTarjaPage", true);
                        ...
                        request.Fotos = new List<VHSTarjaFotos>
    {
        ...
        this.ArrayFoto7 != null ? new VHSTarjaFotos { ArrayFoto = this.ArrayFoto7, Orden = 8 } : null
                        ...
                        var response = await ServiceCedi.RegistraTarja(request);
