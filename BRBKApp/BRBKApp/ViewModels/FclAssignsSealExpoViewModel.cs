...
{
    public class FclAssignsSealExpoViewModel : BaseViewModel
    {
        ...
        public FclAssignsSealExpoViewModel()
        {
            Title = "Assigns Seal Expo";
                ...
                if (DeACuerdo)
                {
                    ...
                    if (flags == false)
                    {
                        ...
                        if (current == NetworkAccess.Internet)
                        {
                            ...
                            AsignaSealExpo objSeal = new AsignaSealExpo();
                            ...
                            ApiModels.AppModels.Base msg = await datos.SetSealAssignsExpo(objSeal, ArrayFoto, ArrayFoto1, ArrayFoto2, ArrayFoto3).ConfigureAwait(true);
