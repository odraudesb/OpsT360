...
{
    public class MtySealRegistersViewModel : BaseViewModel
    {
        ...
        public MtySealRegistersViewModel()
        {
            Title = "Seal Assignment";
                ...
                if (DeACuerdo)
                {
                    ...
                    if (flags == false)
                    {
                        ...
                        if (current == NetworkAccess.Internet)
                        {
                            ...
                            sealAsignacionMuelle objSeal = new sealAsignacionMuelle();
                            ...
                            ApiModels.AppModels.Base msg = await datos.SetSealRegisters(objSeal, ArrayFoto, ArrayFoto1, ArrayFoto2, ArrayFoto3).ConfigureAwait(true);
