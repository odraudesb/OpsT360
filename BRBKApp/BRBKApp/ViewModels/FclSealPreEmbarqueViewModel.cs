...
{
    public class FclSealPreEmbarqueViewModel : BaseViewModel
    {
        ...
        public FclSealPreEmbarqueViewModel()
        {
            Title = "Seal Pre-Embarque";
                ...
                if (DeACuerdo)
                {
                    ...
                    if (flags == false)
                    {
                        ...
                        if (current == NetworkAccess.Internet)
                        {
                            ...
                            ApiModels.AppModels.Base msg = await datos.SetSealPreEmbarque(objSeal, ArrayFoto, ArrayFoto1, ArrayFoto2, ArrayFoto3).ConfigureAwait(true);
