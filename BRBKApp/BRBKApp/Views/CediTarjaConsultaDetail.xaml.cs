...
namespace BRBKApp.Views
{
    ...
    public partial class CediTarjaConsultaDetail : TabbedPage, IQueryAttributable
    {
        public string Origen { get; set; }
        private readonly CediTarjaMensaje _entry;

        public CediTarjaConsultaDetail(CediTarjaMensaje entry = null)
        {
            InitializeComponent();
            _entry = entry;
            this.BindingContext = new CediTarjaConsultaDetailViewModel(entry);
        }

        public CediTarjaConsultaDetail()
        {
            InitializeComponent();
            _entry = null;
            this.BindingContext = new CediTarjaConsultaDetailViewModel();
        }
        ...
        protected override void OnAppearing()
        {
            ...
            var viewModel = this.BindingContext as CediTarjaConsultaDetailViewModel;
            if (viewModel != null)
            {
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"ShowCodeInput en OnAppearing: {viewModel.ShowCodeInput}, ShowDetails: {viewModel.ShowDetails}");
            }
        }
        ...
        private async void OnImageTapped(object sender, EventArgs e)
        {
            ...
            Console.WriteLine(
                $"Sender is Image. GestureRecognizers count: {image.GestureRecognizers.Count}");
            ...
            var parameter = gesture.CommandParameter != null
                ? gesture.CommandParameter.ToString()
                : null;
            ...
            // Obtener el ImageSource correspondiente según el índice (switch clásico)
        ...
        public void ApplyQueryAttributes(IDictionary<string, string> query)
        {
            if (query.ContainsKey("origen"))
            {
                ...
                var vm = this.BindingContext as CediTarjaConsultaDetailViewModel;
                if (vm != null)
                {
                    vm.Origen = origen;
                }
